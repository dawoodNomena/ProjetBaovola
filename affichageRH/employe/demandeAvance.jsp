...
<body>
    <section class="shadow contact-clean" style="background: rgb(3,77,139);">
        <form class="bg-light border rounded border-secondary shadow-lg" method="post" style="background: rgb(248,248,249);">
            <h2 class="text-center">Demande d'avance</h2>
            <div class="form-group mb-3"><input class="form-control" type="number" name="phone" placeholder="montant" inputmode="tel"></div>
            ...
            <div class="form-group mb-3">
                <p class="text-center text-info" style="font-size: 12px;">Pas avant le 15e du mois, pas plus de la moitie de son salaire</p>
            </div>
        </form>
    </section>
